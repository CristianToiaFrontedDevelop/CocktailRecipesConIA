    ...
    <header className={isHome ? 'bg-header bg-center bg-cover' : 'bg-slate-800'}>
      <div className="mx-auto container px-5 py-16">
        <div className="flex justify-between items-center">
          <div>
            <img className="w-32" src={logoCocktail} alt="Logo de Cocktail" />
          </div>
        ...
        {isHome && (
          ...
          >
            ...
            <input 
              ...
              className="cursor-pointer bg-slate-800 hover:bg-slate-900 text-white font-extrabold w-full p-2 rounded-lg uppercase"              name="" 
              id=""
            />
